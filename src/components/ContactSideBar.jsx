export default function ContactSideBar() {
  return (
    <div className="flex flex-col items-center fixed text-white left-8 bottom-0 space-y-4">
      <a href="https://github.com/afifaarg" className="group">
        <svg
          viewBox="0 0 24 24"
          fill="currentColor"
          height="1.75em"
          width="1.75em"
          className="transition-all duration-300 group-hover:translate-x-2 hover:fill-[#6EFFE1]"
        >
      ...
      <a href="https://www.instagram.com/aa.coddes/" className="group">
        <svg
      ...
      >
        <svg
          ...
          height="1.75em"
          width="1.75em"
          className="transition-all duration-300 group-hover:translate-x-2 hover:text-[#6EFFE1]"
        >
      ...
      <a href="https://codepen.io/afifa-argoub" className="group">
        <svg
          viewBox="0 0 24 24"
          fill="currentColor"
          height="1.75em"
