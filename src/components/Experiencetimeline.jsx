export default function Experiencetimeline() {
    return (
      <div className="h-screen flex flex-col items-center justify-center py-10 w-3/4 mx-auto text-greyText" id="experience">
        {/* Title */}
        <div className="flex items-center gap-4">
        <div className="h-px bg-gray-100 w-36"></div>
          <h1 className="text-[#6effe2dc] font-bold text-3xl">Experience</h1>
          <div className="h-px bg-gray-100 w-36"></div>
        </div>
        ...
        <div className="relative border-l-2 border-[#6EFFE1] mt-8 space-y-12">
          ...
          <div className="ml-8">
            ...
            <div className="space-y-2">
              <h3 className="text-lg font-bold text-greyText">Internship - Cerist, Ben Aknoun - Algiers</h3>
              <p className="text-sm italic text-[#B0BEC5]">Part of a graduate project: <span className="text-sm text-[#B0BEC5]" >  Jan 2023 - June 2023</span></p>
          ...
          <div className="ml-8">
            <div className="absolute w-4 h-4 bg-[#6EFFE1] rounded-full -left-2.5"></div>
            <div className="space-y-2">
              <h3 className="text-lg font-bold text-greyText">Full Stack Web Developer - DIVATECH, Mohamadia - Algiers</h3>
              <p className="text-sm italic text-[#B0BEC5]">May 2023 - August 2024</p>
              <p className="text-sm text-[#B0BEC5]">
